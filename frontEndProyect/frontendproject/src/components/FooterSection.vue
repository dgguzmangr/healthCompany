<template>
    <footer class="container-fluid col-12 py-4">
        <div class="row py-2" style="background-color: white;">
            <div class="col-12 col-md-4 py-4 text-center text-md-left">
                <div class="p-2">
                ...
                <div class="text-right">
                    <h5>Nuestas oficinas</h5>
                    <p>Calle 43 # 12-15</p>
                    <p>Transversal 94 # 45-12</p>
                </div>
            </div>
            <div class="col-12 col-md-4 py-4 text-center">
                ...
                <div class="text-right">
                    ...
                    <p>01 8000 66 66 66 </p>
                    <p> Bogotá +57 654 878 2565</p>
                </div>
            </div>
            <div class="col-12 col-md-4 py-4 text-center text-md-right">
                <div class="p-2">
                ...
                <div class="text-right">
                    <h5>Línea Covid-19/ Viruela Símica</h5>
                    <p>01 8000 11 22 33 </p>
                    <p> Bogotá +57 456 878 2565</p>
                </div>
            </div>
        </div>
        <div class= "row text-center py-5" style="background-color: var(--background3);"> 
            <p>2022 © Todos los derechos reservados ǀ Términos y condiciones ǀ Políticas de privacidad ǀ Lineamientos de seguridad ǀ Sostenibilidad</p>
            <p>Navegadores recomendados: Internet Explorer 10.0 o superior; Google Chrome, Firefox o Safari en su última versión</p>
        </div>
        <div class="row text-center developers" style="background-color: white;">
            <p><h5>©2023 DGGUZMANGR Developer</h5></p>
        </div>
    </footer>
</template>
